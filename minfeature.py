...
data=ice_data_15[[ 'pitch3_angle',
       'pitch1_moto_tmp', 'acc_y', 'pitch2_moto_tmp', 'pitch3_moto_tmp',
       'environment_tmp', 'group', 'wind_speed']]
X_train, X_test1, y_train, y_test1 = train_test_split(data, label_15, test_size=0.1, random_state=128, shuffle = True)# shuffle默认为True
...
ice_data_21=ice_data_21[[ 'pitch3_angle',
       'pitch1_moto_tmp', 'acc_y', 'pitch2_moto_tmp', 'pitch3_moto_tmp',
       'environment_tmp', 'group', 'wind_speed']]
