# -*- coding: utf-8 -*-
"""
Created on Sat Jun 20 22:45:45 2020
...
print(Counter(label_15))
smo = SMOTE(random_state=42)
X_smo, y_smo = smo.fit_sample(ice_data_15,label_15)
print(Counter(y_smo))
X_train, X_test1, y_train, y_test1 = train_test_split(X_smo, y_smo, test_size=0.1, random_state=128, shuffle = True)# shuffle默认为True
